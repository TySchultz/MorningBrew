...
enum Styles {
    ...
    enum Text {
        ...
        static let headline = TextStyle(font: .system(.bold), size: 20)
        static let mainFeedHeadline = TextStyle(font:  .system(.bold), size: 28)
        static let mainFeedTitle = TextStyle(font:  .system(.bold), size: 18)
        static let detailArticleTitle = TextStyle(font:  .system(.bold), size: 18)
        static let sectionHeaderHeadline = TextStyle(font: .system(.bold), size: 32)
    ...
    static func setupAppearance() {
        ...
        UINavigationBar.appearance().titleTextAttributes =
            [NSAttributedString.Key.foregroundColor: Styles.Colors.Gray.dark.color]
    }
